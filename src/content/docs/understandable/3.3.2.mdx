...
![이미지. 시각적으로 보이는 레이블이 제공된 예시](/images/image241.png)
...
![이미지. 시각적으로 숨겨진 레이블을 제공한 예시](/images/image242.png)
...
![이미지. 단일 레이블 '휴대폰번호'에 3개의 입력란이 연결되는 예시](/images/image243.png)
...
![이미지. 상품 옵션을 선택할 수 있는 라디오 버튼 예시](/images/image244.png)
...
![이미지. 레이블이 제공되지 않은 검색창 사례](/images/image245.png)
...
![이미지. placeholder만 제공된 예시](/images/image246.png)
...
![이미지. 콤보박스의 첫 번째 옵션을 ‘배송지 선택’으로 레이블처럼 사용한 예시](/images/image247.png)
